...
class repository_voicerecording extends repository {
    ...
    public function get_upload_template() {
        ...
        $params = array(
            ...
            'onclick' => 'if(Y.Lang.trim(Y.one(\'#filenanoname\').get(\'value\'))!=\'\'){uploadNanogongRecording(\'voicerecording\',\'' . $fileuploaderphp . '\');}',
